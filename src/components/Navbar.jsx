    ...
    >
      <nav className="mx-auto max-w-7xl px-6 lg:px-10 flex items-center justify-between h-20">
        <Link to="/" className="flex items-center gap-3 shrink-0" onClick={() => setOpen(false)}>
          <img src={logo} alt="Norcross Hospital" className="h-9 w-auto" />
        </Link>
        ...
        <Link
          to="/contact"
          className="hidden md:inline-flex items-center gap-2 rounded-full bg-blue-800 text-white text-[14px] font-semibold px-5 py-2.5 hover:bg-blue-700 transition-colors"
        >
          Contact Us
        </Link>
